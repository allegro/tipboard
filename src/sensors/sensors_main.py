...
def scheduleYourSensors():  # pragma: no cover
    ...
    scheduler.add_job(sonde3, 'interval', seconds=2)
    scheduler.add_job(sonde4, 'interval', seconds=2)
    ...
    scheduler.add_job(sonde9, 'interval', seconds=2)
    scheduler.add_job(sonde10, 'interval', seconds=2)
